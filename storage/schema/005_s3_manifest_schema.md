...
```text
inbound/{source_message_id}/original.bin
inbound/{source_message_id}/metadata.json
```
...
```json
{
  ...
  "size_bytes": 2481931,
  "object_key": "inbound/src_20260609_0001/original.bin",
...
```text
manifests/source-messages/{source_message_id}.json
```
...
```json
{
  ...
  "media": {
    ...
    "original_key": "inbound/src_20260609_0001/original.bin",
    "metadata_key": "inbound/src_20260609_0001/metadata.json",
    "content_type": "image/jpeg",
    "size_bytes": 2481931
  },
  "current": {
...
```json
{
  ...
  "input": {
    "bucket": "election-system",
    "key": "inbound/src_20260609_0001/original.bin",
    "metadata_key": "inbound/src_20260609_0001/metadata.json",
    "content_type": "image/jpeg",
    "size_bytes": 2481931
  },
...
```json
{
  ...
  "source_message_id": "src_20260609_0001",
  "draft_id": "draft_20260609_0001_r1",
  "draft_key": "drafts/src_20260609_0001/revision-1.json",
  "revision": 1,
  "updated_at": "2026-06-09T06:31:10Z"
}
```
...
```text
updates/jobs/{update_job_id}.json
```
...
```text
indexes/by-line-event-id/{line_event_id}.json
indexes/by-line-message-id/{line_message_id}.json
indexes/by-session/{workflow_session_id}/latest.json
...
```json
{
  ...
  "line_event_id": "01JY...",
  "source_message_id": "src_20260609_0001",
  "source_message_key": "manifests/source-messages/src_20260609_0001.json",
  "created_at": "2026-06-09T06:30:05Z",
  "updated_at": "2026-06-09T06:30:05Z"
}
```
...
1. `inbound/.../original.bin`
2. `inbound/.../metadata.json`
3. `manifests/source-messages/{source_message_id}.json`
4. `indexes/by-line-event-id/{line_event_id}.json`
5. `indexes/by-line-message-id/{line_message_id}.json`
6. `manifests/ocr-jobs/{ocr_job_id}.json`
7. `audit/.../message_received.json`

หลัง OCR สำเร็จ:

1. `drafts/{source_message_id}/revision-{revision}.json`
2. `drafts/{source_message_id}/latest.json`
3. `approvals/{source_message_id}/revision-{revision}.json`
4. `approvals/{source_message_id}/latest.json`
5. `audit/.../draft_created.json`

หลัง approval และ update สำเร็จ:

1. `updates/jobs/{update_job_id}.json`
